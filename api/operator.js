...
if(!url){
throw new Error(
"Vercel is missing SUPABASE_URL"
);
}
...
if(!publishable){
throw new Error(
"Vercel is missing SUPABASE_ANON_KEY"
);
}
...
return {
error:
"No operator authorization token"
};
...
return {
error:
"Invalid operator login session"
};
...
return {
error:
"This Supabase user is not an authorized operator"
};
