...
if(operator.error){
return send(res,401,{error:operator.error});
}
...
return send(res,400,{error:"Invalid day."});
}
...
if(!id){
return send(res,400,{error:"Missing booking ID."});
}

if(!["Approved","Cancelled"].includes(status)){
return send(res,400,{error:"Invalid booking status."});
}
...
return send(res,400,{
error:"A cancelled booking cannot be approved."
});
}
